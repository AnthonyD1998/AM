...
class AM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Trans_Resep_AM")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Trans_Resep_AM")
        ...
        # Variables
        ##################################################
        self.signal_offset = signal_offset = 50
        ...
        self._in_gain_win = RangeWidget(self._in_gain_range, self.set_in_gain, 'Imput Gain', "counter_slider", float)
        self.top_grid_layout.addWidget(self._in_gain_win)
        self._signal_offset_range = Range(0, 100, 0.1, 50, 200)
        self._signal_offset_win = RangeWidget(self._signal_offset_range, self.set_signal_offset, 'signal_offset', "counter_slider", float)
        self.top_grid_layout.addWidget(self._signal_offset_win)
        self.qtgui_time_sink_x_1 = qtgui.time_sink_f(
            2048, #size
            samp_rate, #samp_rate
            'Comparación entre la señal de entrada y salida', #name
            2 #number of inputs
        )
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\Anthony\\Desktop\\Su excelencia ROCK STAR - Soy del Carchi Mosaico Ecuatoriano 2016.wav', True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.blocks_sub_xx_0 = blocks.sub_ff(1)
        self.blocks_null_source_0 = blocks.null_source(gr.sizeof_float*1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_multiply_const_vxx_1 = blocks.multiply_const_ff(in_gain)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 100000, 3, 0, 0)
        self.analog_const_source_x_1 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 1)
        self.analog_const_source_x_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, 1)
        self.analog_agc_xx_1 = analog.agc_ff(60e-9, 0, 1.0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_agc_xx_1, 0), (self.audio_sink_0, 0))
        self.connect((self.analog_agc_xx_1, 0), (self.qtgui_time_sink_x_1, 1))
        ...
        self.connect((self.blocks_sub_xx_0, 0), (self.analog_agc_xx_1, 0))
    ...
    def set_in_gain(self, in_gain):
        ...
        self.blocks_multiply_const_vxx_1.set_k(self.in_gain)
